# ********** Start of header **************
# Title: Exp1a Mobile Phone SAT: Exclusion criteria
#
...
# Exclusion above does not remove participants, BUT there are 6 trials where participants were too slow or too fast
# We have removed those individual trials with the code below

clean.data <- drop_na(clean.data, response)
...
# save the data set 
data <- clean.data
save(data, file = "exp2bSATClean.RData")

#~~~~~~~~~~~~~Trial errors~~~~~~~~~~~~~#
# Use the original data set. 
data <- original.data[!original.data$trialError == " fast",]
...
save(data, file = "exp2bSATRDM.RData")
...
save(data, file = "exp2bSATMNL.RData")
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#