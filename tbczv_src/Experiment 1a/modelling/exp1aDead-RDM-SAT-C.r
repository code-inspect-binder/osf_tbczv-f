...
# log density of the observed choices under subject-level parameters (RDM, SAT-C)
ll <- function(x, data, sample=FALSE) {
  ...
  u[deadlines,] <- as.matrix(
    (data[paste0("opt", 1:n.options, "mcCost")][deadlines,] * x["u_cost_5"]) +
      (data[paste0("opt", 1:n.options, "mcSides")][deadlines,] * x["u_sides_5"]) +
      (data[paste0("opt", 1:n.options, "mcDeliveryTime")][deadlines,] * x["u_deliveryTime_5"]))
  
  u[!deadlines,] <- as.matrix(
    (data[paste0("opt", 1:n.options, "mcCost")][!deadlines,] * x["u_cost_10_20"]) +
      (data[paste0("opt", 1:n.options, "mcSides")][!deadlines,] * x["u_sides_10_20"]) +
      (data[paste0("opt", 1:n.options, "mcDeliveryTime")][!deadlines,] * x["u_deliveryTime_10_20"]))
