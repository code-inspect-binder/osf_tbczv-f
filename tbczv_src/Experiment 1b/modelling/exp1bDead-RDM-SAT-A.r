# hierarchical RDM fit with PMwG to exp1bSAT
rm(list=ls())
...
par_names <- c("u_cost_5", "u_camera_5", "u_memory_5",  "u_battery_5",
               "u_cost_10", "u_camera_10", "u_memory_10", "u_battery_20",
               "u_cost_20", "u_camera_20", "u_memory_20",  "u_battery_10", 
...
## Some priors.
priors <- list(
  theta_mu_mean = c(rep(0, 12), 2, 2, 2,0),
